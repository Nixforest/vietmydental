...
public class DiagnosisCreateRequest extends BaseRequest {
    /** Token */
    ...
    public DiagnosisCreateRequest(String token, String name, String description) {
        super(G01Const.PATH_DIAGNOSIS_CREATE);
        this.token = token;
        this.name = name;
    ...
    protected List<NameValuePair> buildParameter() {
        ...
        try {
            ...
            object.put(DomainConst.KEY_DESCRIPTION, description);
