...
public class PathologicalCreateRequest extends BaseRequest {
    /** Token */
    ...
    public PathologicalCreateRequest(String token, String name, String description) {
        super(G01Const.PATH_PATHOLOGICAL_CREATE);
        this.token = token;
        this.name = name;
