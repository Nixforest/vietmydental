...
public class G01F01S01ListAdapter extends BaseAdapter {
    ...
    public G01F01S01ListAdapter(ArrayList<ConfigExtBean> list, LayoutInflater inflater) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            } else if (item.getId().equals(DomainConst.ITEM_MEDICAL_HISTORY)) {
