...
public class MedicalRecordInfoRequest extends BaseRequest {
    /** Token */
     ...
     * @param id Id
     */
    public MedicalRecordInfoRequest(String token, String id) {
        super(G01Const.PATH_MEDICAL_RECORD_INFO);
        this.token = token;
        this.id = id;
    }
    /**
